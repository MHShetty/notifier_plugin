...
class HttpNotifierExample extends StatelessWidget {
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: n -
                                          () => DropdownButton<HttpRequestType>(
                                              value: httpNotifier.requestType,
                                              isExpanded: true,
                                              items: HttpRequestType.values
                                                  .map(
                                                    (e) => DropdownMenuItem<
                                                        HttpRequestType>(
                                                      value: e,
                                ...
                                (HttpRequestType.values
                                            .indexOf(httpNotifier.requestType) >
                                        4)
                                    ? Column(
                                        children: [
                                          Divider(),
      ...
      body: httpNotifier -
          (r) => httpNotifier.isSyncing
              ? const SmartCircularProgressIndicator()
              : SingleChildScrollView(child: Text(r.toString())),
    );
  }
}
