...
class _NotifierExampleState extends State<NotifierExample> {
  ...
  void dispose() {
    ...
    SharedPreferences.getInstance()
        .then((sp) => sp.setStringList("todos", todos));
  }
                      ...
                      builder: (c) {
                        return IconButton(
                            ...
                            onPressed: () {
                              ...
                              todosN();
                              Scaffold.of(c).showSnackBar(const SnackBar(
                                  content: Text("The todo list was cleared!")));
                            });
                      },
                    )
        ],
      ...
      child: GestureDetector(
        ...
        child: Row(
          children: [
            ...
            Text(todo,
                style: TextStyle(color: temp ? Colors.grey : Colors.black)),
          ],
        ),
      ),
    );
