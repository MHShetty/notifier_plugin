                  ...
                  Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: IconButton(
                            ...
                            onPressed: () {
                              double _bT = bT;
                              swNotifier.elapsed -=
                                  const Duration(seconds: 2) * (bT += 0.25);
                              if (swNotifier.elapsed < Duration(seconds: 2))
                                swNotifier.elapsed = Duration.zero;
                              swNotifier();
                      ...
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: ~(n) => IconButton(
                            icon: Icon(swNotifier.isPlaying
                                ? Icons.pause
                                : Icons.play_arrow),
                            onPressed: () {
                              swNotifier.isPlaying
                                  ? swNotifier.pause()
                                  : swNotifier.play();
                              n();
                            },
                      ...
                      Padding(
                        ...
                        child: IconButton(
                            ...
                            onPressed: () {
                              double _fT = fT;
                              if (swNotifier.elapsed == Duration.zero)
                                swNotifier.elapsed = const Duration(seconds: 2);
                              else
                                swNotifier.elapsed +=
                                    const Duration(seconds: 2) * (fT += 0.25);
                              print(fT);
                              Future.delayed(Duration(milliseconds: 700), () {
