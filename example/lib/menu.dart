                  ...
                  child: ListView(
                    children: [
                      ...
                      ListTile(
                        ...
                        subtitle: Text("A simple example that illustrates the use of a Notifier."),
                      ),
                      ListTile(
                        contentPadding: EdgeInsets.symmetric(horizontal: 10.0,vertical: 4.0),
                        onTap: ()=>Navigator.of(context).pushNamed("swNotifier"),
                        title: Text("6. SWNotifier"),
                        subtitle: Text("A simple stopwatch example that illustrates the use of a SWNotifier."),
                      ),
                    ],
                  ),
                )
